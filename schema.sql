...
--
-- Name: idx_alerts_deleted_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_alerts_deleted_at ON public.alerts USING btree (deleted_at);


--
-- Name: idx_indicators_deleted_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_indicators_deleted_at ON public.indicators USING btree (deleted_at);
